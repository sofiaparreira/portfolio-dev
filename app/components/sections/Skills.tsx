...
export const Skills = () => {
    ...
    const categoryConfig = [
        {
            label: "Front-End",
            icon: <RiTableFill className="text-primary text-lg" />,
            skills: skillsFront,
        ...
        {
            label: "Back-End",
            icon: <RiServerFill className="text-primary text-lg" />,
            skills: skillsBack,
        ...
        {
            label: "Outros",
            icon: <RiToolsFill className="text-primary text-lg" />,
            skills: skillsOthers,
            cols: "lg:grid-cols-3 grid-cols-2",
            span: "col-span-1",
        },
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between mb-5">
                                    <div className="flex gap-3 items-center">
                                        <span className="w-9 h-9 flex justify-center items-center border border-primary/25 rounded-lg bg-gradient-to-br from-primary/10 to-orange-600/10 backdrop-blur-sm">
                                            {icon}
                                        </span>
                                        <h4 className="font-medium text-white">{label}</h4>
                                    </div>

                                    <span className="text-xs text-primary/60 bg-primary/[0.08] border border-primary/15 rounded-full px-2.5 py-0.5">
